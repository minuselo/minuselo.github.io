...
// Переключатель для navbar
$(document).ready(function()
{
var $collapsMenu_ul=$('.navbar-nav');
var $collapsMenu_li=$('.nav-item');
var $collapsMenu=$('.navbar-collapse');

$('.navbar-toggler-icon').on('click', function(){
	if ($collapsMenu_ul.hasClass('navbar-nav__collapser')) {
		$collapsMenu_ul.removeClass('navbar-nav__collapser');
		$collapsMenu_li.removeClass('nav-item__collapser');
	}
	else{
		$collapsMenu_ul.addClass('navbar-nav__collapser');
		$collapsMenu_li.addClass('nav-item__collapser');
	}
})
