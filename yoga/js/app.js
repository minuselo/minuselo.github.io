(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new core(".challenge__slider__slider", {
                ...
                pagination: {
                    ...
                    renderFraction: function(currentClass, totalClass) {
                        return '<span class="pre-currentClass">0</span><div class="' + currentClass + '"></div>' + '<span class="pre-totalClass">0</span><div class="' + totalClass + '">0</div>';
                    }
                },
                scrollbar: {
                    el: ".swiper-scrollbar",
            ...
            new core(".courses__slider__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            new core(".practice__slider__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
